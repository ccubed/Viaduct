...
import gevent, gevent.server, Stonework, configparser
...
class TelHandler:
    ...
    def __init__(self, x as Stonework, key):
        self.stoneref = x
        self.enckey = key
    ...
    def session_start(self):
        ...
        if self.stoneref.getpair(phash,5) > 0:
            self.writeline("You have mail in your inbox.")
